 ...
 */
(function() {
    var app = angular.module('CoolGame', ['ngCookies', 'ngMockE2E', 'ngResource', 'ngRoute'])
    ...
    app.config(function(Character2Provider, $routeProvider){
        Character2Provider.setLevel(10);

        $routeProvider.when('/', {
            templateUrl: "templates/_create.html",
            controller: "CreateCtrl"
        })
        $routeProvider.when('/admin', {
            templateUrl: "templates/_monsters.html",
            controller: "MonsterCtrl",
            resolve: {
                monsterList: function($resource) {
